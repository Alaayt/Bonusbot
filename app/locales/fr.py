STRINGS = {
    ...
    "no_profit_guarantee": "Je ne peux pas vous garantir un profit — aucun opérateur de paris ne le peut honnêtement. Les paris comportent un risque réel, et le bonus lui-même a des conditions d'utilisation (ce n'est généralement pas de l'argent retirable immédiatement). Je peux en revanche vous expliquer l'offre avec précision pour que vous décidiez en toute connaissance de cause.",
