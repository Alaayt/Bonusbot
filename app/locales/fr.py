STRINGS = {
    ...
    "existing_account_needs_new_one": "⚠️ Important : le code promo VIPACE1 et toutes les offres qui y sont liées ne fonctionnent qu'avec un nouveau compte créé avec le code promo lors de l'inscription. Votre compte existant ne peut pas y être rattaché rétroactivement. Si vous souhaitez profiter de ces offres, vous pouvez créer un nouveau compte avec le code promo ci-dessous (en plus de votre compte actuel).",
    "has_account_reply": "Compris. La fonction \"Choisir l'offre qui me convient\" est vraiment pensée pour ceux qui veulent créer un nouveau compte avec le code promo VIPACE1 - la plupart des offres phares (comme le bonus de premier dépôt) sont réservées aux nouveaux comptes. Mais vous restez éligible à d'autres offres sur votre compte actuel - choisissez-en une ci-dessous 👇",
    ...
    "missing_bonus_ask_promo_entered": "Avez-vous saisi le code promo VIPACE1 lors de l'inscription (si l'offre nécessite un nouveau compte) ?",
    ...
    "help_text": (
        ...
        "✅ Vous inscrire avec le code promo VIPACE1\n"
    ...
    "bot_short_description": "Conseiller promotions du jeu - offres expliquées, meilleur choix pour vous, code promo VIPACE1 🎁",
    "bot_full_description": "Découvrez les offres disponibles, apprenez à vous inscrire et à utiliser le code promo VIPACE1. Choisissez votre langue et suivez les instructions à l'intérieur du bot.",
}
