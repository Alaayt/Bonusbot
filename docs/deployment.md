...
| `PROMO_CODE` | افتراضيًا `ACEWIN991` - غيّره فقط إذا تغيّر البروموكود الرسمي |
...
```
ارفع صورة مربعة واضحة (لوجو اللعبة أو تصميم يعكس هوية "مستشار البونصات") - هذا يكمّل شكل الرابط الجميل عند المشاركة (الاسم + الوصف القصير + الصورة معًا).
